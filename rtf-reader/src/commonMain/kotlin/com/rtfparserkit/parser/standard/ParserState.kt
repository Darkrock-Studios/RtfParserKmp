...
internal class ParserState {
    var currentFontExplicitlySet: Boolean = false
    var currentFont: Int = 0
    var currentEncoding: String = Encoding.ANSI_ENCODING
    var currentFontEncoding: String? = null
    var unicodeAlternateSkipCount: Int = 1
