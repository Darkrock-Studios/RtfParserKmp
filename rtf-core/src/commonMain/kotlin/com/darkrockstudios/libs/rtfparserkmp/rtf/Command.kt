...
enum class Command(
    ...
    mdispDef("mdispDef", CommandType.Value),
    ...
    pnseclvl("pnseclvl", CommandType.Destination),
    ...
    outdisponlyhtml("outdisponlyhtml", CommandType.Toggle),
    cocoartf("cocoartf", CommandType.Value),
    cocoasubrtf("cocoasubrtf", CommandType.Value),
    ;
